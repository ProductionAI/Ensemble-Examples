...
CLAUDE_SMALL = "claude-haiku-4-5-20251001"
OPENAI_SMALL = "gpt-4o-mini"
GEMINI_SMALL = "gemini-2.0-flash-lite"
...
def ensemble_router():
    ...
    TIER_MAP = {
        "SIMPLE":  {"caller": call_gemini,  "model": GEMINI_SMALL, "label": f"Gemini Flash Lite ({GEMINI_SMALL})"},
        "MEDIUM":  {"caller": call_openai,  "model": OPENAI_SMALL, "label": f"GPT-4o Mini ({OPENAI_SMALL})"},
        "COMPLEX": {"caller": call_claude,  "model": CLAUDE_MODEL, "label": f"Claude Sonnet ({CLAUDE_MODEL})"},
    }
...
def main():
    ...
    print("  Using: Claude · GPT-4o · Gemini")
    print("▓" * 70)
